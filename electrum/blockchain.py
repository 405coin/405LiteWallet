...
DEFAULT_MAX_TARGET = 0x00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff                       
...
class Blockchain(Logger):
    ...
    def verify_header(cls, header: dict, prev_hash: str, target: int, expected_header_hash: str=None) -> None:
        ...
        if constants.net.TESTNET or getattr(constants.net, 'SKIP_PROOF_OF_WORK_CHECK', False):
            return
    ...
    def get_target(self, index: int) -> int:
        ...
        max_target = getattr(constants.net, 'MAX_TARGET', DEFAULT_MAX_TARGET)
    ...
    def get_chainwork(self, height=None) -> int:
        ...
        if getattr(constants.net, 'CHAINWORK_HEIGHT_ONLY', False):
            return height
        if constants.net.TESTNET:
